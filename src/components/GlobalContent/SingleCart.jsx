...
const AllIds = CartItems.map(product => product.id);
    ...
    return (
        <ScrollView contentContainerStyle={styles.scrollContainer}>
            <View style={styles.mainContainer}>
                <Image source={{ uri: item.image||item.url||item.imageUri}} style={styles.productImage}/>
                <Text style={styles.productName}>{item.title}{item.productName}</Text>
                {/* <Text style={styles.productPrice}>$500.00{item.price}</Text> */}
                <Text style={styles.productPrice}>{item.price}{item.productPrice}</Text>
                ...
                <Text style={styles.cashback}>Save:$20{item.cashback}</Text>
                ...
                {
                     idExists ?<TouchableOpacity style={styles.buttonContainer2} onPress={() => handleCartPress(item)}>
                     <Text style={styles.addToCart}>Remove from Cart</Text>
                 </TouchableOpacity> :
                 <TouchableOpacity style={styles.buttonContainer2} onPress={() => handleCartPress(item)}>
