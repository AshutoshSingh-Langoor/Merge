...
const CartDetails = () => {
  ...
  const [formState, dispatched] = useReducer(reducerHandler, initialFormState);
      ...
      {Cartdata.map(product => (
        <View key={product.id} style={styles.card}>
          ...
          <View style={styles.details}>
            ...
            <Text style={styles.price}><Text style={styles.originalPrice}>$250 {product.originalPrice}</Text> ${product.price}</Text>
            {/* <Text style={styles.cashback}>SAVE $100{product.save}</Text> */}

            <Text style={styles.description}>
              Sold by:bedelighted dev.{product.details}</Text>
            ...
            <View style={styles.buttonContainer}>
              <TouchableOpacity onPress={() => handleQuantityChange(product.id, -1)}>
                <Text style={{ fontSize: 20, color: 'black', fontWeight: '900' }}>-</Text>
              </TouchableOpacity>
              <Text style={{ fontSize: 20, color: 'black' }}>{quantities[product.id]}</Text>
              <TouchableOpacity onPress={() => handleQuantityChange(product.id, 1)}>
            ...
            <Text style={styles.description} onPress={() => handleRemoveFromCart(product)} >Remove Item</Text>
